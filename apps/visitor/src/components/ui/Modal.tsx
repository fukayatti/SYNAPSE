...
// 2026-07-05: register(apps/register/src/components/ui/Modal.tsx) から移植。
// 各ページで生の div モーダルを個別実装していたため、共通のモーダル外枠
// (RawBlock デザイン: backdrop-blur / border-thick / 角丸なし / font-mono) を導入する。
// Escape キー閉じ・背景スクロールロック・aria 属性 (role="dialog" / aria-modal) を付与。
