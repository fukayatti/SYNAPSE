                  ...
                  {menuSalesData.map((item, idx) => {
                    ...
                    return (
                      <div key={idx} className="space-y-1">
                        ...
                        <div className="w-full h-4 border border-border bg-muted rounded-none relative">
                          <div
                            style={{ width: `${pct}%` }}
          ...
          <CardContent>
            <div className="space-y-2 max-h-[300px] overflow-y-auto pr-2">
              {orders?.map((order) => (
                <div
                  key={order.id}
                  className="flex justify-between items-center p-3 border border-border rounded-none text-xs font-mono"
                >
                  <div>
